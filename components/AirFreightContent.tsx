...
import { Plane, Globe, Clock, Shield, ArrowRight } from 'lucide-react'
...
const features = [
  {
    ...
    description: 'Fastest shipping option for time-sensitive cargo'
  },
  {
    icon: Globe,
    title: 'Global Network',
    description: 'Worldwide coverage with major airline partnerships'
  },
  {
    icon: Clock,
    title: 'Priority Handling',
    description: 'Expedited processing and customs clearance'
  },
  {
    icon: Shield,
    title: 'Cargo Insurance',
    description: 'Comprehensive coverage for air freight shipments'
  }
]
...
export function AirFreightContent() {
  return (
    <div className="pt-32">
      {/* Hero Section */}
        ...
        <div className="relative container mx-auto px-4 py-20 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <Plane className="h-20 w-20 mx-auto mb-6 text-white/80" />
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Air Freight Services
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
                Worldwide air freight services with express delivery, global coverage, 
                priority handling, and fast transit times for your urgent shipments.
              </p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Fastest Global Shipping Solution
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Our air freight services provide the fastest shipping option for time-sensitive cargo. 
                With global airline partnerships and priority handling, we ensure your shipments reach 
                their destination quickly and safely.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                From express delivery to consolidated shipping, we offer flexible solutions to meet 
                your timeline and budget requirements. Our experienced team handles everything from 
                booking to customs clearance.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the benefits of air freight shipping with our comprehensive services
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive air freight solutions tailored to your specific needs
            </p>
          </motion.div>
