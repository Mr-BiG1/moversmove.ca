...
const features = [
  {
    ...
    description: 'Complete office and business relocation services'
  },
  {
    icon: Package,
    title: 'Equipment Moving',
    description: 'Safe transportation of office equipment and furniture'
  },
  {
    icon: Shield,
    title: 'Minimal Disruption',
    description: 'Efficient moves with minimal business interruption'
  },
  {
    icon: Clock,
...
const businessTypes = [
  'Office Moves', 'Retail Stores', 'Medical Offices', 'Dental Clinics',
  'Law Firms', 'Accounting Firms', 'Restaurants', 'Warehouses'
]
...
const processSteps = [
  {
    step: '01',
    title: 'Assessment',
    description: 'Comprehensive evaluation of your commercial moving needs'
  },
  {
    step: '02',
    title: 'Planning',
    description: 'Create a detailed moving plan with minimal disruption'
  },
  {
    step: '03',
    title: 'Packing',
    description: 'Professional packing and equipment preparation'
  },
  {
    step: '04',
    title: 'Moving',
    description: 'Efficient transportation to new location'
  },
  {
    step: '05',
    title: 'Setup',
    description: 'Complete setup and equipment installation'
  }
]

export function CommercialMovesContent() {
  return (
    <div className="pt-32">
      {/* Hero Section */}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Efficient commercial relocation process with minimal business disruption
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Office furniture and equipment moving</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">IT equipment and computer systems</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Filing cabinets and document storage</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Complete office setup and installation</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">After-hours and weekend moving</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Equipment disassembly and reassembly</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Secure document and file handling</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Storage solutions for temporary needs</span>
                </li>
              </ul>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Commercial Moving & Related Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Complete commercial moving solutions and related business services
            </p>
          </motion.div>
