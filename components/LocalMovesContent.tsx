...
import { GTA_CITIES } from '@/lib/constants'

const features = [
  {
    icon: Truck,
    title: 'Same-Day Service',
    description: 'Quick and efficient local moves with same-day service available'
  },
  {
    icon: Package,
    title: 'Professional Packing',
    description: 'Expert packing services to protect your belongings'
  },
  {
    icon: Shield,
    title: 'Furniture Protection',
    description: 'Specialized equipment and techniques to protect your furniture'
  },
  {
    icon: MapPin,
    title: 'Local Expertise',
    description: 'Deep knowledge of GTA neighborhoods and traffic patterns'
  }
]
...
const serviceAreas = [
  ...
  'Newmarket', 'Aurora', 'King City', 'Caledon', 'Milton', 'Georgetown'
]
...
const processSteps = [
  {
    step: '01',
    title: 'Assessment',
    description: 'We evaluate your moving needs and provide a detailed quote'
  },
  {
    step: '02',
    title: 'Planning',
    description: 'Create a customized moving plan with timeline and logistics'
  },
  {
    step: '03',
    title: 'Packing',
    description: 'Professional packing and preparation of your belongings'
  },
  {
    step: '04',
    title: 'Moving',
    description: 'Safe and efficient transportation to your new location'
  },
  {
    step: '05',
    title: 'Unpacking',
    description: 'Assistance with unpacking and setting up your new space'
  }
]

export function LocalMovesContent() {
  return (
    <div className="pt-32">
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Furniture placement in new location</span>
                </li>
              </ul>
            </motion.div>
