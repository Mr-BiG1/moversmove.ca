...
const testimonials = [
  {
    name: 'Sarah Johnson',
    location: 'Toronto, ON',
    text: 'Movers Move made our international relocation seamless. Professional, punctual, and caring team.',
    rating: 5
  },
  {
    name: 'Michael Chen',
    location: 'Vancouver, BC',
    text: 'Excellent service for our office move. Minimal downtime and everything arrived safely.',
    rating: 5
  },
  {
    name: 'Emily Rodriguez',
    location: 'Montreal, QC',
    text: 'The team handled our piano move with incredible care. Highly recommended!',
    rating: 5
  }
]
  ...
  return (
    <div className="pt-32">
      ...
      <section className="relative bg-gradient-to-br from-primary via-primary/90 to-accent/80 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center opacity-10"></div>
